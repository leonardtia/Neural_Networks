...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 16 22:32:04 2018
深层神经网络的例子
@author: leonard_tia
"""
...
parameters = dnnm.L_layer_model(train_x, train_y, layers_dims, num_iterations = 1800, 
                                print_cost = True)
pred_train = dnnm.predict(train_x, train_y, parameters)
pred_test = dnnm.predict(test_x, test_y, parameters)
